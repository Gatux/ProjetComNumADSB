...
La simulation du récepteur ADSB-B a permis d'étudier des données réelles obtenu à l'aide d'un récepteur.\\
...
Par la suite, il a fallu intégré la démodulation ce qui a permis de traité un flux réel de données provenant d'un récepteur radio. Le flux de données se présente sous forme d'un buffer de 2 millions de points correspondant à 0.5 seconde de temps de réception.
